...
**The Kalman filter is the optimal way to track a state you can't measure directly: alternate "predict" (push your estimate through the dynamics model, uncertainty grows) and "update" (blend in the new measurement, weighted by how much you trust it vs the prediction).** It is recursive Bayesian inference for linear-Gaussian systems — and the formal answer to every ad-hoc question about how hard to smooth your data.
